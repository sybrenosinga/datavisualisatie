...
# collect data
students16 = df16['stats_number_students']
students17 = df17['stats_number_students']
students18 = df18['stats_number_students']

# put data in list
boxstudents = [students16, students17, students18]
...
#
# # Create the boxplot
# bp = ax.boxplot(boxstudents)
#
# # Save the figure
# fig.savefig('students2.png', bbox_inches='tight')


# histogram 2016
arr_hist16, edges16 = np.histogram(df16['stats_number_students'][:800],
                               bins = int(150000/4000),
                               range = [0, 150000])

# Put the information in a dataframe
uni16 = pd.DataFrame({'arr_students': arr_hist16,
                       'left': edges16[:-1],
                       'right': edges16[1:]})

# Create the blank plot
p16 = figure(plot_height = 600, plot_width = 600,
           title = 'Histogram of students',
...
# Add a quad glyph
p16.quad(bottom=0, top=uni16['arr_students'],
       left=uni16['left'], right=uni16['right'],
       fill_color='green', line_color='black')

# histogram 2017
arr_hist17, edges17 = np.histogram(df17['stats_number_students'][:800],
                               bins = int(150000/4000),
                               range = [0, 150000])

# Put the information in a dataframe
uni17 = pd.DataFrame({'arr_students': arr_hist17,
                       'left': edges17[:-1],
                       'right': edges17[1:]})
...
# Add a quad glyph
p17.quad(bottom=0, top=uni17['arr_students'],
       left=uni17['left'], right=uni17['right'],
       fill_color='green', line_color='black')

# histogram 2018
arr_hist18, edges18 = np.histogram(df18['stats_number_students'][:800],
                               bins = int(150000/4000),
                               range = [0, 150000])

# Put the information in a dataframe
uni18 = pd.DataFrame({'arr_students': arr_hist18,
                       'left': edges18[:-1],
                       'right': edges18[1:]})
...
# Add a quad glyph
p18.quad(bottom=0, top=uni18['arr_students'],
